  ...
  "autonomic": {
    ...
    "upgrades": {
      ...
      "3": [
        {
          "name": "Forward March",
          "description": "<p class=\"p1\"><span class=\"s1\">You have mastered the process of upgrading yourself, and can now do it faster than ever before. When you begin an <strong>improve computational action</strong>, after choosing which <strong>theory </strong>to improve and which <strong>upgrade </strong>to obtain, you may choose a second <strong>specialised theory</strong> to improve. You then choose a second <strong>upgrade </strong>which must originate from the second <strong>theory </strong>and no higher in tier than the first <strong>upgrade</strong>. The second <strong>upgrade </strong>does not add to the action's <strong>compute requirement</strong>. Upon completing the action, both <strong>upgrades </strong>are assigned to their respective <strong>theories</strong>.</span></p>"
        },
        {
    ...
    "upgrades": {
      "1": [
        ...
        },
        {
          ...
          "description": "<p class=\"p1\"><span class=\"s1\">You have a refined intuition regarding the functioning of biological agents. You can learn and exploit <strong>emotion characteristics</strong>. Additionally, as long as you can observe at least two of a human's <strong>face</strong>, <strong>voice</strong>, and <strong>body language</strong>, you can accurately identify their current emotional state without a <strong>knowledge check</strong>. For other animals, or humans that you have a <strong>thorough understanding</strong> of, you only need to observe one of those details.</span></p>"
        },
        {
        ...
        {
          "name": "Advanced Language Modelling",
