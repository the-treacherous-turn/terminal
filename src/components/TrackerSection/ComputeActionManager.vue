...
<template>
  <div class="flex flex-col overflow-hidden">
    ...
    <h1 class="px-4 pt-4 text-2xl uppercase">Computational Actions</h1>
    <div id="compute-action-list" class="px-4 overflow-y-scroll" ref="scroller" @scroll.passive="saveScrollPos">
        <draggable
